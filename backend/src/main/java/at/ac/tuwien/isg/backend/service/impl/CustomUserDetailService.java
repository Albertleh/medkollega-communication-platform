...
import at.ac.tuwien.isg.backend.exception.UserNotFoundException;
import at.ac.tuwien.isg.backend.repository.UserRepository;
import at.ac.tuwien.isg.backend.security.JwtTokenizer;
...
public class CustomUserDetailService implements UserService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        try {
            ...
            if (UserRole.ADMIN.equals(applicationUser.getRole())) {
    ...
    public ApplicationUser findApplicationUserByEmail(String email) {
        ...
        ApplicationUser applicationUser = userRepository.findUserByEmail(email).orElseThrow(UserNotFoundException::new);
